...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication1.Domain.Entities.TransactionDelivery", b =>
                {
                    ...
                    b.ToTable("transactiondeliveries", (string)null);
                });
            ...
            modelBuilder.Entity("WebApplication1.Domain.Entities.TransactionItemsDelivered", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("TransactionDeliveryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TransactionDeliveryId");
            ...
            modelBuilder.Entity("WebApplication1.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Domain.Entities.Transaction", "Transaction")
                        .WithOne()
                        .HasForeignKey("WebApplication1.Domain.Entities.Purchase", "TrasactionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("WebApplication1.Domain.Entities.Sale", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Domain.Entities.Transaction", "Transaction")
                        .WithOne()
                        .HasForeignKey("WebApplication1.Domain.Entities.Sale", "TrasactionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("WebApplication1.Domain.Entities.TransactionItemsDelivered", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Domain.Entities.TransactionDelivery", "TransactionDelivery")
                        .WithMany("TransactionItemsDelivered")
                        .HasForeignKey("TransactionDeliveryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Item");

                    b.Navigation("TransactionDelivery");
                });
